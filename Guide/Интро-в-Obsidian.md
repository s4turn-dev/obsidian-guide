...
Кроме поиска по словам в текущем открытом файле на `Ctrl-F`, в Obsidian (с помощью [плагина](Плагины-для-Obsidian.md) **Search**) можно осуществлять поиск по всему хранилищу.
...
- Поведение редактора
- Внешний вид (в том числе цветовые темы)
...
Этого должно быть достаточно, чтобы ты чувствовал себя комфортно в среде Obsidian. Следующие рекомендуемые материалы помогут тебе прокачать само конспектирование:
